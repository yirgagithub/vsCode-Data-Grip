...
import { ErDiagramReport } from '../../services/erDiagramService';

export class ErDiagramPanel {
  static async open(context: vscode.ExtensionContext, report: ErDiagramReport): Promise<void> {
  ...
  private static html(webview: vscode.Webview, report: ErDiagramReport): string {
