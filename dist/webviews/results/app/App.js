...
function App() {
    ...
    return ((0, jsx_runtime_1.jsxs)("main", { className: "app", children: [(0, jsx_runtime_1.jsx)(ResultsTabs_1.ResultsTabs, { tabs: tabs, activeTabId: active.id }), (0, jsx_runtime_1.jsx)(ResultToolbar_1.ResultToolbar, { tab: active, resultSet: resultSet }), (0, jsx_runtime_1.jsx)("div", { className: "resultset-tabs", children: active.resultSets.length > 0 ? active.resultSets.map((set, index) => ((0, jsx_runtime_1.jsxs)("button", { className: index === activeResultSetIndex ? 'active' : '', onClick: () => setActiveResultSetIndex(index), title: `${set.command ?? 'Result'} - ${set.rowCount} rows`, children: [(0, jsx_runtime_1.jsx)("span", { children: index + 1 }), (0, jsx_runtime_1.jsx)("span", { children: set.command ?? 'Result' })] }, set.id))) : (0, jsx_runtime_1.jsx)("span", { className: "muted", children: "Messages" }) }), active.executionStatus === 'failed' ? (0, jsx_runtime_1.jsx)(MessagesPanel_1.MessagesPanel, { tab: active }) : (0, jsx_runtime_1.jsx)(ResultGrid_1.ResultGrid, { tab: active, resultSet: resultSet }), (0, jsx_runtime_1.jsx)(StatusBar_1.StatusBar, { tab: active, resultSet: resultSet })] }));
}
