...
function ResultsTabs({ tabs, activeTabId }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "tabs result-tabs", role: "tablist", "aria-label": "SQL result tabs", children: [(0, jsx_runtime_1.jsxs)("div", { className: "tab-strip-leading", "aria-hidden": "true", children: [(0, jsx_runtime_1.jsx)("span", { className: "codicon-lite console-icon", children: "\u25A3" }), (0, jsx_runtime_1.jsx)("span", { children: "Output" })] }), tabs.map((tab) => ((0, jsx_runtime_1.jsxs)("div", { className: `tab ${tab.id === activeTabId ? 'active' : ''} status-${tab.executionStatus}`, title: [
                    ...
                    tab.executionStatus
                        ...
                        }, role: "tab", "aria-selected": tab.id === activeTabId, "aria-label": `${tab.customTitle ?? tab.title}, ${tab.executionStatus}`, children: [(0, jsx_runtime_1.jsx)("span", { className: `connection-dot ${tab.databaseType} status-${tab.executionStatus}` }), (0, jsx_runtime_1.jsx)("span", { className: "tab-object-icon", "aria-hidden": "true", children: "\u25A6" }), (0, jsx_runtime_1.jsx)("span", { className: "tab-title", children: tab.customTitle ?? tab.title })] }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: `icon tab-icon-action ${tab.pinned ? 'on' : ''}`, title: tab.pinned ? 'Unpin result tab' : 'Pin result tab', "aria-label": tab.pinned ? 'Unpin result tab' : 'Pin result tab', onClick: (event) => {
                            event.stopPropagation();
                            pinTab(tab.id, !tab.pinned);
                        }, children: "\u2316" }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "icon tab-icon-action close-action", title: "Close", "aria-label": "Close result tab", onClick: (event) => {
                            event.stopPropagation();
                            closeTab(tab.id);
                        }, children: "\u00D7" })] }, tab.id))), (0, jsx_runtime_1.jsx)("div", { className: "tabs-overflow-shadow", "aria-hidden": "true" })] }));
}
