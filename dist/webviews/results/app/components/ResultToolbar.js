...
function ResultToolbar({ tab, resultSet }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "toolbar", children: [(0, jsx_runtime_1.jsx)("button", { className: "tool primary", title: "Rerun query", onClick: rerun, children: "Run" }), (0, jsx_runtime_1.jsxs)("label", { className: "limit-control", title: "Rows fetched by the next run", children: [(0, jsx_runtime_1.jsx)("span", { children: "Rows" }), (0, jsx_runtime_1.jsxs)("select", { value: limitValue, onChange: (event) => changeLimit(event.target.value), children: [(0, jsx_runtime_1.jsx)("option", { value: "500", children: "500" }), (0, jsx_runtime_1.jsx)("option", { value: "1000", children: "1,000" }), (0, jsx_runtime_1.jsx)("option", { value: "5000", children: "5,000" }), (0, jsx_runtime_1.jsx)("option", { value: "all", children: "All" }), (0, jsx_runtime_1.jsx)("option", { value: "custom", children: maxRows && !['500', '1000', '5000'].includes(String(maxRows)) ? maxRows.toLocaleString() : 'Custom...' })] })] }), (0, jsx_runtime_1.jsx)("button", { className: "tool", title: tab.pinned ? 'Unpin tab' : 'Pin tab', onClick: () => pinTab(tab.id, !tab.pinned), children: tab.pinned ? 'Unpin' : 'Pin' }), (0, jsx_runtime_1.jsx)("span", { className: "separator" }), (0, jsx_runtime_1.jsx)("button", { className: "tool", title: "Copy fetched rows as TSV", onClick: () => vscode_1.vscode.postMessage({ type: 'copy', text: (0, format_1.rowsToTsv)(rows) }), children: "Copy" }), (0, jsx_runtime_1.jsx)("button", { className: "tool", title: "Copy fetched rows as CSV", onClick: () => vscode_1.vscode.postMessage({ type: 'copy', text: (0, format_1.rowsToCsv)(rows) }), children: "CSV" }), (0, jsx_runtime_1.jsx)("button", { className: "tool", title: "Copy fetched rows as JSON", onClick: () => vscode_1.vscode.postMessage({ type: 'copy', text: JSON.stringify(rows, null, 2) }), children: "JSON" }), (0, jsx_runtime_1.jsx)("span", { className: "toolbar-spacer" }), (0, jsx_runtime_1.jsx)("span", { className: `execution-badge ${tab.executionStatus}`, children: tab.executionStatus }), (0, jsx_runtime_1.jsx)("span", { className: "muted", children: resultSet?.command ?? '' })] }));
}
