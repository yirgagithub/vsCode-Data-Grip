...
function StatusBar({ tab, resultSet }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("footer", { className: "statusbar", children: [(0, jsx_runtime_1.jsx)("span", { className: "statusbar-item strong", children: tab.databaseType }), (0, jsx_runtime_1.jsx)("span", { className: "statusbar-item", children: tab.databaseName ?? 'database' }), (0, jsx_runtime_1.jsx)("span", { className: "statusbar-item", children: tab.schemaName ?? 'schema' }), (0, jsx_runtime_1.jsx)("span", { className: "statusbar-spacer" }), (0, jsx_runtime_1.jsx)("span", { className: "statusbar-item", children: isRunning ? 'loading rows' : isPlan ? `${tab.plan?.format ?? 'plan'} plan` : `${(resultSet?.rowCount ?? tab.rowCount ?? 0).toLocaleString()} rows` }), (0, jsx_runtime_1.jsx)("span", { className: "statusbar-item", children: isPlan ? (tab.plan?.analyze ? 'analyze' : 'estimate') : tab.maxRows ? `limit ${tab.maxRows.toLocaleString()} @ ${tab.rowOffset ?? 0}` : 'all rows' }), (0, jsx_runtime_1.jsx)("span", { className: "statusbar-item", children: txMode === 'manual' ? (txOpen ? 'tx open' : 'tx idle') : 'auto-commit' }), (0, jsx_runtime_1.jsxs)("span", { className: "statusbar-item", children: ["execution: ", isRunning ? 'running' : `${(tab.executionTimeMs ?? resultSet?.durationMs ?? 0).toLocaleString()} ms`] }), (0, jsx_runtime_1.jsx)("span", { className: `statusbar-item status-text ${tab.executionStatus}`, children: tab.executionStatus })] }));
}
