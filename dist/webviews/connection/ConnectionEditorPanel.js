...
const connectionOnboarding_1 = require("./connectionOnboarding");
class ConnectionEditorPanel {
    ...
    html(webview, form) {
        ...
        const guidance = JSON.stringify(connectionOnboarding_1.ENGINE_GUIDANCE_BY_DATABASE_TYPE).replace(/</g, '\\u003c');
